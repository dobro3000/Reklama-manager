    ...
    public partial class SettingsWindow : Window
    {
        ...
        private void LoadSettings()
        {
            if (ProcessFactory.GetSettingsProcess().GetSettings() != null)
            {
                ...
                {
                    this.tbPassword.Password = builder.Password;
        ...
        {
            if (ProcessFactory.GetSettingsProcess().SetSettings(this.tbServer.Text, this.tbDataBase.Text, this.tbUser.Text, this.tbPassword.Password))
            {
